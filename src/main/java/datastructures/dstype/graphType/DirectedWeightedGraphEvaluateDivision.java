...
/*
Intuition
Given the above problem statement, it seems intuitive that one could apply the datastructures.dstype.graphType.BacktrackingAllPaths algorithm,
...
Since we employ the recursion in the datastructures.dstype.graphType.BacktrackingAllPaths, we would consume additional memory in the function call stack,
which could amount to O(N) space.
In addition, we used a set visited to keep track of the nodes we visited during the datastructures.dstype.graphType.BacktrackingAllPaths.
