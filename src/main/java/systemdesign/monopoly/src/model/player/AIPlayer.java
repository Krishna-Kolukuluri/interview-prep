...
import systemdesign.monopoly.src.model.player.strategy.AIStrategy;
import systemdesign.monopoly.src.model.tiles.*;
import systemdesign.monopoly.src.model.tiles.property.TitleDeedCard;
import java.util.Observable;
import java.util.Observer;

import static systemdesign.monopoly.src.model.tiles.GameActionConstants.DOWNGRADE_PROPERTY_ACTION;
import static systemdesign.monopoly.src.model.tiles.GameActionConstants.MORTGAGE_PROPERTY_ACTION;
